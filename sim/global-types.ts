...
type Nonstandard = 'Past' | 'Future' | 'Unobtainable' | 'CAP' | 'LGPE' | 'Custom' | 'Gigantamax' | 'AG' | 'Uber' | 'IBL';
...
declare namespace TierTypes {
	export type Singles = "AG" | "Uber" | "(Uber)" | "OU" | "(OU)" | "UUBL" | "UU" | "RUBL" | "RU" | "NUBL" | "NU" |
		"(NU)" | "PUBL" | "PU" | "(PU)" | "ZUBL" | "ZU" | "IBL" | "DI" | "IIBL" | "DII" | "IIIBL" | "DIII" | "IVBL" | "DIV" | "VBL" | "DV" | "VIBL" |
	 "DVI" | "VIIBL" | "DVII" | "VIIIBL" | "DVIII" | "IXBL" | "DIX" | "XBL" | "DX" | "XIBL" | "DXI" | "XIIBL" | "DXII" | "(DXII)" | "NFE" | "LC";
